...
export default function Monthlyreport({expense,setExpense}) {
 ...
 handleget();
    ...
    <span>
    <div>
    <Button variant="contained" style={{marginLeft:"70vw",marginTop:"20px"}} onClick={()=>history.push("/")}>Back</Button>
    <h3 style={{textAlign:"center",paddingTop:"10px",paddingLeft:"6vw"}}>
    Monthly Report Of The Expanses</h3></div></span>
    <Divider variant="middle" />
    <div className='container'>
    <div className="card-container" >
    {expense.map((ex,idx)=>(
      <div className="stud-card" key={idx} style={{width:"250px"}}>
